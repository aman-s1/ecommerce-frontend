    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (token) {
                    const userResponse = await fetch('http://localhost:5000/shop', {
                        method: 'GET',
                ...
                // Fetch all products
                const productsResponse = await fetch('http://localhost:5000/shop/products', {
                    method: 'GET',
                    headers: { 'Authorization': `Bearer ${token || ''}` },
                });
                ...
                // Fetch cart items
                const cartResponse = await fetch('http://localhost:5000/cart/get-items', {
                    method: 'GET',
                    headers: { 'Authorization': `Bearer ${token}` },
                });
                if (cartResponse.ok) {
